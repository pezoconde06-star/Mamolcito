...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Feliz San Valentín, mi Wwita Carla Alvarado ❤️
Aunque lo nuestro sea virtual, lo que siento por ti es muy real. Gracias por cada llamada, por cada momento feliz que compartimos, por las risas y hasta por esas partidas de Free Fire que hacen que todo sea más divertido cuando estamos juntos.
Me encanta pasar tiempo contigo, hablar contigo y sentir que, aunque haya distancia, estamos conectados de verdad. No necesito tenerte cerca para saber que eres alguien especial para mí.
Te amo mucho, Wwita ❤️`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Jheferson";
...
window.addEventListener("load", () => {
  ...
  const musica = params.get("musica") || "music1.mp3";

  const audio = new Audio("Music/" + musica);
